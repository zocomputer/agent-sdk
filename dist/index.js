// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/index.ts
import { join as join8 } from "node:path";

// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/attachments.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/async-tasks.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/backgroundable.ts
import { z } from "zod";
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/bounded-output.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/dir-conventions.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/instructions.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/run.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/steer-inbox.ts
import {
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/steer.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/steer-tool.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/tools/bash.ts
import { defineTool as defineTool2 } from "eve/tools";
import { z as z2 } from "zod";

// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/park-delivery.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/watch-output.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/tools/edit.ts
import { defineTool as defineTool3 } from "eve/tools";
import { z as z3 } from "zod";

// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/path-locks.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/workspace-io.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/glob-match.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/list-files.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/read-text.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/walk.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/workspace.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/tools/glob.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/tools/grep.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/tools/read.ts
import { defineTool as defineTool6 } from "eve/tools";
import { z as z6 } from "zod";
import { basename } from "node:path";

// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/file-kind.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/file-view.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/read-file-content.ts
import { imageSize } from "image-size";

// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/extract/cache.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/extract/docx.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/extract/pdf.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/extract/sheet.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/tools/tasks.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/tools/webfetch.ts
import { defineTool as defineTool8 } from "eve/tools";
import { z as z8 } from "zod";
import { basename as basename2, join as join7 } from "node:path";

// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/web-fetch.ts
import { Parser } from "htmlparser2";
import { parseHTML as parseHTML2 } from "linkedom";
import TurndownService from "turndown";

// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/web-page.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/tools/write.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/sandbox-io.ts
...
`)) {
    ...
    if (file === undefined || lineNo === undefined || text === undefined)
      continue;
    matches.push({
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/hooks.ts
import { Client } from "eve/client";
import { defineHook } from "eve/hooks";

// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/redeliver.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/explore.ts
...
// ../../../../../tmp/agent-sdk-mirror-nKD5Vr/repo/src/mock-model.ts
var STORY_SENTENCES = [
