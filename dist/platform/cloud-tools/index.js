// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/cloud-tools/image.ts
import { randomUUID } from "node:crypto";
import { generateImage } from "ai";
import { defineTool } from "eve/tools";
import { z as z4 } from "zod";

// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/runtime-ai/gateway.ts
import { createGateway } from "ai";

// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/runtime-ai/session-fetch.ts
...
// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/runtime-ai/stream-guards.ts
...
// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/runtime-ai/gateway-config.ts
...
// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/cloud-tools/asset-path.ts
import { z } from "zod";
...
// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/cloud-tools/tool-meta.ts
var CLOUD_TOOL_META = {
  image: {
...
// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/cloud-tools/tool-shared.ts
import { z as z3 } from "zod";

// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/cloud-tools/state-consent.ts
...
// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/cloud-tools/state-files.ts
...
// ../../../../../tmp/agent-sdk-mirror-11YCnL/repo/platform/cloud-tools/video.ts
...
var AspectRatioSchema2 = z5.enum(["16:9", "9:16", "1:1"]);
var GenerateVideoInputSchema = z5.object({
  aspect_ratio: AspectRatioSchema2.optional().describe("Aspect ratio; omit for the model's default."),
  duration_seconds: z5.number().int().positive().max(30).optional().describe("Clip length in seconds (max 30); omit for the model's short default."),
  model: z5.string().trim().min(1).optional().describe("Video model id; omit to use the default."),
  output_dir: OutputDirSchema.optional().describe("Relative state-file directory for the generated asset; defaults to 'generated'."),
  prompt: z5.string().trim().min(1).max(4000).describe("What to generate."),
  seed: z5.number().int().nonnegative().optional().describe("Reproducibility seed.")
});
