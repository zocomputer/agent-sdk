// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/image.ts
import { randomUUID } from "node:crypto";
import { generateImage } from "ai";
import { defineTool as defineTool2 } from "eve/tools";
import { z as z5 } from "zod";

// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/runtime-ai/gateway.ts
import { createGateway } from "ai";

// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/runtime-ai/session-fetch.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/runtime-ai/stream-guards.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/runtime-ai/gateway-config.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/runtime-ai/catalog.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/asset-path.ts
import { z } from "zod";
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-asset.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-preflight.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-catalog-parser.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-catalog-snapshot.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-catalog-cache.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-models.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-adapters.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-registry.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-models-default.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/image-lane.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-lineage.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/tool-meta.ts
var CLOUD_TOOL_META = {
  image: {
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/tool-shared.ts
import { z as z4 } from "zod";

// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/state-consent.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/state-files.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/edit-image.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/video.ts
import { randomUUID as randomUUID3 } from "node:crypto";
import { experimental_generateVideo as generateVideo } from "ai";
import { defineTool as defineTool4 } from "eve/tools";
import { z as z7 } from "zod";

// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/video-lane.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/edit-video.ts
import { experimental_generateVideo as generateVideo2 } from "ai";
import { defineTool as defineTool5 } from "eve/tools";
import { z as z8 } from "zod";

// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/provider-media-input.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/generate-speech.ts
import { randomUUID as randomUUID5 } from "node:crypto";
import { generateSpeech } from "ai";
import { defineTool as defineTool6 } from "eve/tools";
import { z as z9 } from "zod";

// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/audio-lane.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/transcribe-audio.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/media-contracts.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/web-search.ts
import { generateText } from "ai";
import { defineTool as defineTool8 } from "eve/tools";
import { z as z11 } from "zod";

// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/search-adapters.ts
import { gateway } from "@ai-sdk/gateway";

// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/search-contracts.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/search-providers.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/x-search.ts
...
// ../../../../../tmp/agent-sdk-mirror-bTS43z/repo/platform/cloud-tools/maps-search.ts
